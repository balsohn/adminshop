  ...
  <div id="memberView">
    <table width="400" align="center">
      ...
      <tr> <!-- 클릭을 해서 수정폼이 나오게 -->
        ...
        <td>
          ...
          <div id="after" style="display:none;">
           <form method="post" action="emailOk">
      ...
      <tr> <!-- 처음부터 수정폼으로 작업 -->
        <td> 전화번호 </td>
        <td>
         <form method="post" action="phoneOk">
   ...
   <c:if test="${err==1}"> 
    <div id="pwdMsg" align="center" style="color:red;font-size:11px"> 비밀번호가 틀립니다. </div>
   </c:if>
    <div id="pwdChg">
       <div> <h4> 비밀번호 변경하기 </h4></div>
       <form method="post" action="pwdChgOk">
