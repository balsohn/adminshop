...
<body> <!-- index.jsp : (웹서버 기본문서 : index.html, index.htm , index.jsp -->
   ...
   <div id="second">
     ...
     <a href="member"> 회원가입 </a> | <a href="login"> 로그인 </a>| 고객센터▼
    </c:when>
    <c:otherwise>
    	<a href="memberView">${name}</a>님 | <a href="logout">로그아웃</a> | 고객센터▼
    </c:otherwise>
    </c:choose>
   </div>
   ...
   <div id="third">
     <div id="left"> 
       <img src="imgs/logo.png" valign="middle"> <span id="a1">마켓컬리</span> <span id="a2"> | </span> <span id="a3">뷰티컬리</span>
     </div> <!-- 로고 , 글자  -->
     <div id="center"> 
       <div id="search">
          <input type="text" id="text" placeholder="검색어를 입력하세요" onkeyup="check(this)">
          <img src="imgs/x.png" valign="middle" id="xbtn" onclick="hide()">
          <img src="imgs/search.png" valign="middle">
       </div> 
     </div> <!-- 검색창 -->
     <div id="right"> <img src="imgs/icon.png" valign="middle"> </div> <!-- 링크 아이콘 -->
   </div>
